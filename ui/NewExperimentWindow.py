...
from PySide6.QtWidgets import (
    ...
    QPushButton, QComboBox, QMessageBox, QRadioButton, QButtonGroup
)
...
from ui.ARMO_EQ_ui import SimpleQuestionnairePage  # 重用舊的問卷頁面
...
class NewExperimentWindow(QMainWindow):
    """新實驗主視窗"""
    ...
    def __init__(self, debug_mode: bool = False):
        ...
        # 實驗參數
        self.subject_id = None      # 1-30
        self.session_number = None  # 1-6
        self.group = None           # 'A' or 'B'
        self.category = None        # 音樂類別（如 "Nature"）
        self.category_code = None   # 類別代碼（如 "NA"）

        # 音樂資訊
        self.music_catalog = None
        self.song_order = []  # 播放順序 ['001', '002'] 或 ['002', '001']
        self.music_files = []  # 實際音檔路徑
    ...
    def show_start_page(self):
        ...
        self.group_a_radio.setChecked(True)  # 預設A組
    ...
    def create_result_directory(self):
        ...
        dir_name = f"P{self.subject_id:03d}_S{self.session_number}_G{self.group}_{timestamp}"
